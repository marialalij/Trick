 ...
 */
final class Version20211011222122 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045FD8F0A91E FOREIGN KEY (trick) REFERENCES trick (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE video ADD CONSTRAINT FK_7CC7DA2CD8F0A91E FOREIGN KEY (trick) REFERENCES trick (id) ON UPDATE NO ACTION ON DELETE CASCADE');
