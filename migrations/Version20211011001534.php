 ...
 */
final class Version20211011001534 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Trick ADD author INT DEFAULT NULL, DROP author_id');
        $this->addSql('ALTER TABLE Trick ADD CONSTRAINT FK_1931861ABDAFD8C8 FOREIGN KEY (author) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE CASCADE');
